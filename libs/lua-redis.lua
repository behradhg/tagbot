local redis = {
    _VERSION     = 'tagchi-lua 3.0.4',
    _DESCRIPTION = 'A Lua client library for the ads storage system.',
    _COPYRIGHT   = 'Copyright (C) 2015-2016 tec-now',
}
for k,v in pairs(redis) do print(k,v) end
